    ...
    const sections = [
      {
        ...
        body:
          "256-bit AES encrypted push-to-talk communication. No tracking, no stored data, and no recordings. Total privacy, always.",
      },
      {
        emoji: "🛠️",
        title: "12-MONTH WARRANTY",
        body:
          "Includes a 12-month parts warranty and 7-day-a-week customer support from our local team in West Michigan.",
      },
      {
        emoji: "🛡️",
        title: "30-DAY GUARANTEE",
        body:
          "Try it risk-free. If you’re not satisfied within 30 days, return it for a full refund—no hassle, no questions asked.",
      },
      {
        emoji: "📦",
        title: "FREE UPS SHIPPING FROM MICHIGAN!",
        body:
          "Orders ship from our Michigan facility with free UPS delivery in 3–4 business days. Every order includes tracking.",
      },
      {
        emoji: "🌐",
        title: "NATIONWIDE COVERAGE",
        body:
          "Stay connected coast to coast with our push-to-talk network. Works anywhere with a signal—no cell service needed.",
      },
      {
        emoji: "📋",
        title: "WHAT’S INCLUDED:",
        body:
          "Your device, charging cable, built-in SIM, pre-installed PTT software, and quick-start instructions. Ready to use right out of the box.",
      },
    ];
