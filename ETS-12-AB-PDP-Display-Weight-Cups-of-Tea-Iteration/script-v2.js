(() => {
  ...
  const packageOptions = [
    { size: "2 oz", servings: "25+ Servings", description: "Sip your way to serenity for a month!", price: 7.49, value: "2oz" },
    { size: "8 oz", servings: "100+ Servings", description: "Sip, savor, and savor some more for three months!", price: 22.49, value: "8oz" }
  ];
